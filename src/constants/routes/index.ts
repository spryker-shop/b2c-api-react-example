...
export const pathAuthenticationPage = `${config.WEB_PATH}authentication`;
export const pathLoginPage = `${pathAuthenticationPage}/login`;
export const pathRegisterPage = `${pathAuthenticationPage}/register`;
...
export const pathCustomerWishlistDetail = `${pathWishlistsPage}/:wishlistId`;
export const pathCustomerOrderHistory = `${pathCustomerPage}/order`;
export const pathCustomerOrderDetailsBase = `${pathCustomerOrderHistory}/details`;
export const pathCustomerOrderDetails = `${pathCustomerOrderDetailsBase}/:orderId`;
export const pathForgotPassword = `${config.WEB_PATH}password/forgotten`;
export const pathResetPassword = `${config.WEB_PATH}password/restore/:restoreKey`;
export const pathCustomerProfile = `${pathCustomerPage}/profile`;
export const pathCustomerOverview = `${pathCustomerPage}/overview`;
export const pathCustomerAddresses = `${pathCustomerPage}/addresses`;
export const pathAddressFormUpdateBase = `${pathCustomerAddresses}/update`;
export const pathAddressFormUpdate = `${pathAddressFormUpdateBase}/:addressId`;
export const pathAddressFormNew = `${pathCustomerAddresses}/new`;
