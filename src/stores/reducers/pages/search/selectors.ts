...
export const getSpellingSuggestion = (state: IReduxStore, props: IReduxOwnProps): string | null =>
    state.pageSearch.data && state.pageSearch.data.spellingSuggestion
        ? state.pageSearch.data.spellingSuggestion
        : null;

export const getSortParamLocalizedNames = (state: IReduxStore, props: IReduxOwnProps): IIndexSignature | null =>
    state.pageSearch.data && state.pageSearch.data.sortParamLocalizedNames
        ? state.pageSearch.data.sortParamLocalizedNames
        : null;

export const getCategoriesLocalizedName = (state: IReduxStore, props: IReduxOwnProps): string | null =>
