...
export const isAppInitiated = (state: IReduxStore, props: IReduxOwnProps): boolean => state.init.data.ok;
...
export const getAppCurrency = (state: IReduxStore, props: IReduxOwnProps): string | null =>
    isAppInitiated(state, props) ? state.init.data.currency : null;

export const getAppLocale = (state: IReduxStore, props: IReduxOwnProps): string | null =>
    isAppInitiated(state, props) ? state.init.data.locale : APP_LOCALE_DEFAULT;

export const getAppTimeZone = (state: IReduxStore, props: IReduxOwnProps): string | null =>
    isAppInitiated(state, props) ? state.init.data.timeZone : null;

export const getCounties = (state: IReduxStore, props: IReduxOwnProps): ICountry[] =>
    isAppInitiated(state, props) ? state.init.data.countries : null;
